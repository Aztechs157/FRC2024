...
public class Constants {
    ...
    public static class DriveConstants {
        ...
        public static final double ANGLE_PULSE_PER_ROTATION = 1; // This is the pulse/rev of the motor encoder. Not
                                                                 // absolute.
        public static final double MAX_SPEED = 12.5; // set to 17.3 ft per second
    ...
    public static class ShooterConstants {
        ...
        public static final PIDController DEFLECTOR_MOTOR_PID = new PIDController(0.00125, 0.002, 0);
